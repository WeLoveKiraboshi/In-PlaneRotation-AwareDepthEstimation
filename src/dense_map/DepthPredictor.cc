...
void DepthPredictor::show_DenseFusion_processing_time()
{
    // unit is sec(micro sec)
    float totaltime = 0;
    for(int ni= 0; ni < vTimesDenseFusion.size(); ni++){
        if(vTimesDenseFusion[ni] <= 0){
            std::cout << "vTimesDenseFusion idx = " << ni << " have minus values..." << std::endl;
            vTimesDenseFusion.erase(vTimesDenseFusion.begin()+ni);
        }else{
            totaltime+=vTimesDenseFusion[ni];
        }
    }
    sort(vTimesDenseFusion.begin(),vTimesDenseFusion.end());
    cout << "-------" << endl << endl;
    cout << "DenseFusion vector size: " << vTimesDenseFusion.size() << endl;
    cout << "median DenseFusion time: " << vTimesDenseFusion[int(vTimesDenseFusion.size()/2)] << endl;
    cout << "mean DenseFusion time: " << totaltime/vTimesDenseFusion.size() << endl;
    cout << "min DenseFusion time: " << vTimesDenseFusion[0] << endl;
    cout << "max DenseFusion time: " << vTimesDenseFusion[vTimesDenseFusion.size()-1] << endl;
    cout << endl;
